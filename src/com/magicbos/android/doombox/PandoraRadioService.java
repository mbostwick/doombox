...
import com.magicbos.pandora.PandoraRadio;
import com.magicbos.pandora.Song;
import com.magicbos.pandora.Station;
...
public class PandoraRadioService extends Service {
	...
	private PandoraRadioListener receiverHeadphoneStuff;
	...
	public void onCreate() {
		synchronized(lock) {
			...
			receiverHeadphoneStuff = new PandoraRadioListener();
			this.registerReceiver(receiverHeadphoneStuff, new IntentFilter(Intent.ACTION_HEADSET_PLUG));
			
		}
	}
	
	public void onDestroy (){
		this.unregisterReceiver(receiverHeadphoneStuff);
	}
	@Override
	...
	public Song getCurrentSong() {
		//TODO if the user dose not pick a station this should not be called
